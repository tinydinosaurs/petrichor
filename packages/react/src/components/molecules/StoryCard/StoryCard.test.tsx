...
describe('StoryCard', () => {
  ...
  describe('anonymous mode', () => {
    ...
    it('does not render contributors', () => {
      render(<StoryCard {...anonProps} contributors={[{ name: 'Neo' }, { name: 'Bella' }]} />);
  ...
  describe('completed mode', () => {
    ...
    it('renders contributors', () => {
      render(<StoryCard {...completedProps} contributors={[{ name: 'Neo' }, { name: 'Bella' }]} />);
  ...
  describe('active mode', () => {
    ...
    it('renders "Continue story" CTA when below min segments', () => {
      render(<StoryCard {...activeProps} currentSegments={3} minSegments={5} />);
    ...
    it('renders "Complete story" CTA when at or above min segments', () => {
      render(<StoryCard {...activeProps} currentSegments={5} minSegments={5} />);
  ...
  describe('avatar overflow', () => {
    it('shows up to 3 avatars', () => {
      render(
        <StoryCard
          {...baseProps}
          contributors={[{ name: 'Neo' }, { name: 'Bella' }, { name: 'Molly' }]}
        />,
      );
