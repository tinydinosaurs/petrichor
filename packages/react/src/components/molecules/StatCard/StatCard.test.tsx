...
describe('StatCard', () => {
	describe('rendering', () => {
		...
		it('spreads additional props', () => {
			render(
				<StatCard data-testid="stat" label="Points" value="2,840" />,
			);
	...
	describe('trend', () => {
		...
		it('generates accessible aria-label for upward trend', () => {
			...
			expect(
				screen.getByLabelText('Up +124 vs last month'),
			).toBeInTheDocument();
		});
		...
		it('generates accessible aria-label for downward trend', () => {
			...
			expect(
				screen.getByLabelText('Down −3% vs last month'),
			).toBeInTheDocument();
		});
		...
		it('generates accessible aria-label for neutral trend', () => {
			...
			expect(
				screen.getByLabelText('No change No change'),
			).toBeInTheDocument();
		});
