...
export const TrendNeutral: Story = {
  ...
  args: {
    label: 'Current rank',
    value: '#1',
    trend: { direction: 'neutral', value: 'No change', label: 'vs last month' },
    icon: <ChartIcon />,
  },
}
...
export const TrendInverse: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Set positive=false on trend when up means bad — errors, losses, timeouts. The arrow still points up but renders in error color.',
      },
    },
  },
}
