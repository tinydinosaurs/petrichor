...
describe('Card', () => {
	...
	describe('Card.Divider', () => {
		...
		it('is aria-hidden', () => {
			...
			expect(document.querySelector('hr')).toHaveAttribute(
				'aria-hidden',
				'true',
			);
		});
	...
	describe('Card.Empty', () => {
		...
		it('renders description when provided', () => {
			...
			expect(
				screen.getByText('Start by creating a new story'),
			).toBeInTheDocument();
		});
		...
		it('renders action when provided', () => {
			render(
				<Card>
					<Card.Empty
						message="No stories"
						action={<button>Create story</button>}
					/>
				</Card>,
			);
			expect(
	...
	describe('compound composition', () => {
		it('renders a fully composed card', () => {
			...
			expect(
				screen.getByRole('button', { name: 'Read story' }),
			).toBeInTheDocument();
		});
	});
});
