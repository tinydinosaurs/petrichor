...
export const Bare: Story = {
	render: () => (
		<Card>
			...
			>
				Bare card — just the surface. No sub-components. Add your own
				padding and layout.
			</div>
		</Card>
	),
	parameters: {
		docs: {
			description: {
				story: 'The card surface without any sub-components. Use when you need full control over the interior layout.',
			},
		},
	},
};
...
export const EmptyState: Story = {
	...
	parameters: {
		docs: {
			description: {
				story: 'Empty state with duotone icon, message, description, and CTA. Always tell users why the card is empty and what they can do about it.',
			},
		},
	},
};
...
export const Loading: Story = {
	...
	parameters: {
		docs: {
			description: {
				story: 'Skeleton loading state. Content hidden, shimmer animation shows while data fetches.',
			},
		},
	},
};
...
export const AsArticle: Story = {
	...
	render: () => (
		<Card as="article" aria-label="Story: The Clockmaker's Last Dream">
			...
			<Card.Body>
				...
				>
					The door opened onto a street that hadn't existed
					yesterday...
				</p>
			</Card.Body>
			<Card.Footer>
	...
	parameters: {
		docs: {
			description: {
				story: 'Use as="article" for standalone content cards. Adds a semantic article landmark navigable by screen readers.',
			},
		},
	},
};
