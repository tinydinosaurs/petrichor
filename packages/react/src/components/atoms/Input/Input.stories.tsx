...
const meta: Meta<typeof Input> = {
  ...
  argTypes: {
    label: {
      control: 'text',
      description: 'Always required. Used as the visible label and screen reader label.',
    },
    type: {
      control: 'select',
...
export const Password: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Password inputs include a built-in visibility toggle. No extra configuration needed.',
      },
    },
  },
};
...
export const Search: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'hideLabel keeps the label in the DOM for screen readers without showing it visually. Always provide a meaningful label even when hidden.',
      },
    },
  },
};
...
export const ExquisiteCorpseEditor: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'The writing editor pattern for Exquisite Corpse — character count shown as guidance.',
      },
    },
  },
};
