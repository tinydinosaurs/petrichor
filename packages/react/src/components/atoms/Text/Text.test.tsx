...
describe('Text', () => {
  ...
  describe('as prop overrides default element', () => {
    it('renders heading2 variant as h3 element', () => {
      render(<Text variant="heading2" as="h3">Title</Text>)
      expect(screen.getByRole('heading', { level: 3 })).toBeInTheDocument()
    })
    ...
    it('renders caption as div', () => {
      render(<Text variant="caption" as="div">Small text</Text>)
  ...
  describe('rendering', () => {
    ...
    it('forwards ref', () => {
      ...
      render(<Text ref={ref} variant="body">Text</Text>)
      expect(ref.current).not.toBeNull()
    })

    it('merges custom className', () => {
      render(<Text variant="body" className="custom" data-testid="text">Text</Text>)
    ...
    it('renders with truncate prop', () => {
      render(<Text variant="body" truncate data-testid="text">Long text</Text>)
  ...
  describe('all variants render without error', () => {
    ...
    it.each(variants)('renders variant=%s', (variant) => {
      render(<Text variant={variant} data-testid="text">Content</Text>)
      expect(screen.getByTestId('text')).toBeInTheDocument()
    })
  })
  ...
  describe('accessibility', () => {
    ...
    it('preserves document outline when as prop overrides element', () => {
      render(
        <div>
          <Text variant="heading1">Page title</Text>
          <Text variant="heading2" as="h3">Visually h2, semantically h3</Text>
        </div>,
      )
      expect(screen.getByRole('heading', { level: 1 })).toBeInTheDocument()
      expect(screen.getByRole('heading', { level: 3 })).toBeInTheDocument()
