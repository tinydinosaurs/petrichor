    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
      ...
      <div>
        ...
        <Text variant="body-lg">
          Your win rate is trending upward this season. Three consecutive wins have moved you into
          the top 10.
        </Text>
      </div>
      <div>
        ...
        <Text variant="body">
          Regular body text for descriptions, card content, and general reading surfaces.
        </Text>
      </div>
      <div>
        <Text
        ...
        <Text variant="body-sm">
          Smaller body text for secondary content, helper text, and supporting information.
        </Text>
      </div>
      <div>
        <Text
...
export const DisplayVariant: Story = {
  ...
  render: () => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
      ...
      <Text variant="body-sm">
        The display variant uses font-display — Fraunces on Dusk Rose, Inter on Raindrop. Switch
        brands in the toolbar to see the personality difference.
      </Text>
    </div>
  ),
  parameters: {
    docs: {
      description: {
        story:
          'The display variant is where brand personality is most visible. Fraunces on Dusk Rose has intentional wonkiness suited to surrealist fiction. Inter on Raindrop is clean and technical.',
      },
    },
  },
};
...
export const Polymorphism: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Use the as prop when visual hierarchy and document outline diverge. Both examples above look identical — but their semantic elements differ. Screen readers and search engines see the correct structure.',
      },
    },
  },
};
...
export const DuskRoseContext: Story = {
  ...
  render: () => (
    ...
    >
      ...
      <Text variant="body-lg">
        ...
        because the rain smelled of copper and every clockmaker knows that time runs backwards on
        Tuesdays.
      </Text>
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Switch to Dusk Rose brand to see Fraunces render for the display variant — editorial, slightly wonky, suited to surrealist fiction.',
      },
    },
  },
};
