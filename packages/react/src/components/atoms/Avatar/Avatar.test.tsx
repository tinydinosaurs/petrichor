...
describe('Avatar', () => {
  ...
  describe('accessibility', () => {
    ...
    it('accepts explicit aria-label overriding name', () => {
      render(<Avatar data-testid="avatar" name="Jane Smith" aria-label="Jane Smith's avatar" />);
      expect(screen.getByTestId('avatar')).toHaveAttribute('aria-label', "Jane Smith's avatar");
    });
