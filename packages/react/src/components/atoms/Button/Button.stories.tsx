...
const meta: Meta<typeof Button> = {
  ...
  argTypes: {
    variant: {
      control: 'select',
      options: ['primary', 'secondary', 'ghost', 'danger', 'ghost-danger'],
    ...
    iconOnly: {
      control: 'boolean',
      description: 'Square button — requires aria-label for accessibility.',
      table: { defaultValue: { summary: 'false' } },
    },
    asChild: {
      control: 'boolean',
...
export const Danger: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Use only for destructive, irreversible actions. Never for anything non-destructive.',
      },
    },
  },
};
...
export const GhostDanger: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Destructive but low emphasis — for inline list actions where a filled danger button would be too alarming.',
      },
    },
  },
};
...
export const IconOnlyStory: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Always provide an aria-label when using iconOnly. The label is read by screen readers.',
      },
    },
  },
};
...
export const AsLink: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Use asChild to render button styles on an anchor element. The button renders as an <a> tag — correct semantics, correct styles.',
      },
    },
  },
};
