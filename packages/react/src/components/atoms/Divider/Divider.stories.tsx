...
export const Vertical: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Vertical divider separates inline content. Requires a flex parent with a defined height. align-self: stretch makes it fill the parent height automatically.',
      },
    },
  },
};
...
export const InContext: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Vertical divider in a toolbar — separates related groups of actions. This pattern appears in the Exquisite Corpse rich text editor toolbar.',
      },
    },
  },
};
