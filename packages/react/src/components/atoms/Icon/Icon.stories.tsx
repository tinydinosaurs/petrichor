...
export const Weights: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'All six Phosphor weights. Duotone is reserved for expressive moments — empty states, hero sections. Regular is the Raindrop default, Light is the Dusk Rose default.',
      },
    },
  },
};
...
export const Duotone: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Duotone at xl size — the expressive register. Weather icons feel especially at home in the Petrichor palette.',
      },
    },
  },
};
...
export const ColorInheritance: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Icon inherits color from the parent element via currentColor. Set color on the parent, not the icon.',
      },
    },
  },
};
...
export const Decorative: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'No label — aria-hidden="true". Screen reader ignores it. Use when nearby text already conveys the meaning.',
      },
    },
  },
};
...
export const Informative: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'With label — role="img" + aria-label set. Screen reader announces "Warning, image". Use when the icon conveys meaning not expressed in nearby text.',
      },
    },
  },
};
